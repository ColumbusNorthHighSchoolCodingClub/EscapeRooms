...
public class Item {
    ...
    public boolean pickUpOnClick() {
        return pickUpOnClick;
    }

    public void enablePickUpOnClick() {
        pickUpOnClick = true;
    }
    ...
    public void reactToMousePress(Point p) {
        //System.out.println("A mouse press occured, but the Item has not overriden the reactToMousePress method");
    }

    public void reactToMouseRelease(Point p) {
        //System.out.println("A mouse release occured, but the Item has not overriden the reactToMousePress method");
    }
